...
resource "azurerm_kubernetes_cluster_node_pool" "Enterprise_machine_learning_jobs" {
  ...
  node_count            = 0
  mode                  = "User"
  name                  = "appspool002" # name must start with a lowercase letter, have max length of 12, and only have characters a-z0-9
  ...
  vm_size              = "Standard_E8as_v4" #"Standard_DS2_v2" #"standard_nc24ads_a100_v4" #"Standard_NC6s_v3"
  priority             = "Regular"

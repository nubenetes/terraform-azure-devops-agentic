...
output "id_linux_webapp_applink_cloud_apiEurope" {
  value = local.deploy_Europe ? module.europe.0.id_linux_webapp_applink_cloud_api : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "id_linux_webapp_app-analysis_pdf_rendererEurope" {
  value = local.deploy_Europe ? module.europe.0.id_linux_webapp_app-analysis_pdf_renderer : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "id_linux_webapp_app-analysis_viewer_front_spaEurope" {
  value = local.deploy_Europe ? module.europe.0.id_linux_webapp_app-analysis_viewer_front_spa : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
...
output "id_linux_webapp_applink_cloud_apiUS" {
  value = local.deploy_United_States ? module.us.0.id_linux_webapp_applink_cloud_api : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
}
output "id_linux_webapp_app-analysis_pdf_rendererUS" {
  value = local.deploy_United_States ? module.us.0.id_linux_webapp_app-analysis_pdf_renderer : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
}
output "id_linux_webapp_app-analysis_viewer_front_spaUS" {
  value = local.deploy_United_States ? module.us.0.id_linux_webapp_app-analysis_viewer_front_spa : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
...
# MongoDB
#############
output "mongodb_project_nameEurope" {
  value = local.deploy_Europe ? module.europe.0.mongodb_project_name : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "mongodb_project_idEurope" {
  value = local.deploy_Europe ? module.europe.0.mongodb_project_id : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "mongodb_ipaccesslistEurope" {
  value = local.deploy_Europe ? module.europe.0.mongodb_ipaccesslist : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "mongodb_connection_stringsEurope" { # type object - key:value
  value = local.deploy_Europe ? module.europe.0.mongodb_connection_strings : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "mongodb_atla_cluster_nameEurope" {
  value = local.deploy_Europe ? module.europe.0.mongodbatlas_cluster_name : null
  depends_on = [
    module.europe,
  ]
}
output "mongodb_atla_cluster_nameUS" {
  value = local.deploy_United_States ? module.us.0.mongodbatlas_cluster_name : null
  depends_on = [
    module.us,
  ]
}
output "mongodb_atlas_database_nameEurope" {
  value = local.deploy_Europe ? module.europe.0.mongodb_atlas_database_name : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "mongodb_project_nameUS" {
  value = local.deploy_United_States ? module.us.0.mongodb_project_name : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
}
output "mongodb_project_idUS" {
  value = local.deploy_United_States ? module.us.0.mongodb_project_id : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
}
output "mongodb_ipaccesslistUS" {
  value = local.deploy_United_States ? module.us.0.mongodb_ipaccesslist : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
}
output "mongodb_connection_stringsUS" { # type object - key:value
  value = local.deploy_United_States ? module.us.0.mongodb_connection_strings : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
}
output "mongodb_atlas_database_nameUS" {
  value = local.deploy_United_States ? module.us.0.mongodb_atlas_database_name : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
...
output "mongodb_portal_url_with_clusters_in_projectEurope" {
  value = local.deploy_Europe ? module.europe.0.mongodb_portal_url_with_clusters_in_project : null
  # Feature Flag on Terraform
  depends_on = [
    module.europe,
  ]
}
output "mongodb_portal_url_with_clusters_in_projectUS" {
  value = local.deploy_United_States ? module.us.0.mongodb_portal_url_with_clusters_in_project : null
  # Feature Flag on Terraform
  depends_on = [
    module.us,
  ]
...
#   ]
# }
output "testuser1_credentialsEurope" {
  value = local.deploy_Europe ? module.europe.0.testuser1_credentials : null
  # Feature Flag on Terraform
  sensitive = true
  depends_on = [
    module.europe,
...
output "testadmin_credentialsEurope" {
  value = local.deploy_Europe ? module.europe.0.testadmin_credentials : null
  # Feature Flag on Terraform
  sensitive = true
  depends_on = [
    module.europe,
...
output "testuser1_credentialsUS" {
  value = local.deploy_United_States ? module.us.0.testuser1_credentials : null
  # Feature Flag on Terraform
  sensitive = true
  depends_on = [
    module.us,
...
output "testadmin_credentialsUS" {
  value = local.deploy_United_States ? module.us.0.testadmin_credentials : null
  # Feature Flag on Terraform
  sensitive = true
  depends_on = [
    module.us,

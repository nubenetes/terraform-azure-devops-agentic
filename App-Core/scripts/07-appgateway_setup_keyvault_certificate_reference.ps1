...
$MyApplicationGateway=$args[0]
write-host $MyApplicationGateway
$MyResourceGroup=$args[1] 
write-host $MyResourceGroup
$MyManagedIdentity=$args[2]
write-host $MyManagedIdentity
$MyKeyVaultName=$args[3]
write-host $MyKeyVaultName
$MyCertificateName=$args[4]
write-host $MyCertificateName
$MyAzureSubscription=$args[5]
write-host $MyAzureSubscription

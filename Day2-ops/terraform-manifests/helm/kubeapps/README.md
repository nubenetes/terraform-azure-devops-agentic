...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                                      | `2.7.0-debian-11-r22`        |
...
| `apprepository.image.tag`                                   | Kubeapps AppRepository Controller image tag (immutable tags are recommended)                                                                                                                             | `2.7.0-scratch-r1`                          |
...
| `apprepository.syncImage.tag`                               | Kubeapps Asset Syncer image tag (immutable tags are recommended)                                                                                                                                         | `2.7.0-scratch-r1`                          |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                                                      | `2.7.0-debian-11-r19`             |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                                                                                                   | `2.7.0-debian-11-r20`              |
...
- [How to configure Kubeapps with Ingress](#ingress)

# Kubecost helm chart
Helm chart for the Kubecost project, which is created to monitor and manage Kubernetes resource spend. Please contact cloud-admin@example.com or visit [kubecost.com](http://kubecost.com) for more info.

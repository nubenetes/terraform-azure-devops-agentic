...
You may also `helm show values` on this chart's [dependencies](#added-dependencies) for additional options.
...
The chart has added 3 [dependencies](#added-dependencies).
...
spec:
  ...
  azureDisk:
    ...
    diskURI: /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/sample-migration-resource-group/providers/Microsoft.Compute/disks/pvc-prometheus-migration-prometheus-0
    fsType: ""
    kind: Managed
    readOnly: false
  capacity:
...
The metrics bind address of kube-proxy is default to `127.0.0.1:10249` that prometheus instances **cannot** access to. You should expose metrics by changing `metricsBindAddress` field value to `127.0.0.1:10249` if you want to collect them.

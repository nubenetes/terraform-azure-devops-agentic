...
variable "secret_aks_kube_admin_config_client_certificate_europe" {
...
variable "secret_aks_kube_admin_config_client_key_europe" {
...
variable "secret_aks_kube_admin_config_client_certificate_unitedstates" {
  description = "aks_kube_config_client_certificate"
  type        = string
  sensitive   = true
  default     = "value"
...
variable "secret_aks_kube_admin_config_client_key_unitedstates" {
  description = "aks_kube_config_client_key"
  type        = string
  sensitive   = true
  default     = "value"

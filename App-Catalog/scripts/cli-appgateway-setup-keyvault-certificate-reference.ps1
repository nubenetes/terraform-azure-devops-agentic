...
$MyApplicationGateway='agw-app-analysis-myclient-dev'
$MyResourceGroup='rg-catalog-myclient-dev'
$MyManagedIdentity='id-kv-app-analysis-myclient-dev'
$MyKeyVaultName='kv-app-analysis-myclientdev'
